# Java'nın Temelleri — Meta Blok Örnekleri v1.3

## CODE_META — Derlenecek kod
...
## CODE_META — Hatalı kod

```markdown
<!-- CODE_META
id: karar-yapilari_hata01
chapter_id: karar-yapilari
kind: broken_example
title: "Atama ve karşılaştırma hatası"
file: "AtamaKarsilastirmaHatali.java"
extract: false
test: skip
github: false
qr: none
